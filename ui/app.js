...
$(function() {
  ...
  function displayNewMenu(data) {
    ...
    $(".option__item").on('click', function(e) {
      ...
      $.post('https://dark-missions/selectOption', JSON.stringify({
        menuID: data.menuID,
        key: key,
  ...
  function updateSpeech(data) {
    ...
    typeWriter(data.speech, () => {
      ...
      $('.slider__wrapper').find(".slider").prop('disabled', false).removeClass('locked');
      $('.slider__wrapper').find(".slider__submit").prop('disabled', false).removeClass('locked');
      $.post('https://dark-missions/speechComplete', JSON.stringify({
        menuID: data.menuID
      }));
    ...
    if ($menu.length) {
      ...
      if ($sliderWrapper.length === 0) {
        ...
        $('.slider__wrapper').find(".slider__submit").on('click', function() {
          ...
          $.post('https://dark-missions/sliderConfirm', JSON.stringify({
            menuID: data.menuID,
  ...
  function closeMenu(data) {
    ...
    $.post('https://dark-missions/close', JSON.stringify({ menuID: data.menuID }));
  };
  ...
  function closeAllMenus() {
    ...
    $.post('https://dark-missions/closeAll', JSON.stringify({}));
  }
